...
class NezamiScraper:
    def __init__(self, output_file: str = "nezami_ma.jsonl", delay: float = 2.0):
    ...
    def get_poem_url_path(self, poem_number: int) -> str:
        return f"/nezami/5ganj/makhzanolasrar/sh{poem_number}"
    ...
    def scrape_range(self, start: int = 1, end: int = 60, resume: bool = True) -> None:
